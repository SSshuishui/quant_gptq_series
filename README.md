...
| :------------------------------------------------------ | -------: | :------: | :-------: | :--: |
| [GPTQ](https://arxiv.org/pdf/2210.17323)                   |      yes |   yes   |   TODO   | yes |
| [PB-LLM](https://arxiv.org/pdf/2310.00034)                 |      yes |   yes   |   TODO   | yes |
| [BiLLM](https://arxiv.org/pdf/2402.04291)                  |      yes |   yes   |   TODO   | yes |
| [CLAQ](https://arxiv.org/pdf/2405.17233)                   |      yes |   yes   |   TODO   | yes |
| [Z-Fold](https://aclanthology.org/2023.emnlp-main.892.pdf) |      yes |   yes   |   TODO   | yes |
| [Slim](https://arxiv.org/pdf/2405.14917)                   |      yes |   yes   |   TODO   | yes |
| [QuIP](https://arxiv.org/pdf/2307.13304)                   |      yes |   yes   |   TODO   | yes |
| AWRQ                                                    |      yes |   yes   |   TODO   | yes |
| [DecoupleQ](https://arxiv.org/pdf/2404.12759)              |      yes |   yes   |   TODO   | yes |
| [OWQ](https://arxiv.org/pdf/2306.02272)                    |      yes |   yes   |   TODO   | yes |
| [GPTVQ](https://arxiv.org/pdf/2402.15319)                  |      yes |   yes   |   TODO   | yes |
| [MagR](https://arxiv.org/pdf/2406.00800)                   |      yes |   yes   |   TODO   | yes |
| [SpQR](https://arxiv.org/pdf/2306.03078)                   |      yes |   yes   |   TODO   | yes |

## GPTQ

```
python llama.py --method gptq --model ${MODEL_DIR} --dataset c4 --wbits 4 --true_sequential --act_order --save
```
...
python llama.py --method claq --model ${MODEL_DIR} --dataset c4 --wbits 4 --true_sequential --act_order  --save

# Run Adaptive Precision quantization to quantize the model to 2.1 bit and compute PPL results
python llama.py --method claq --model ${MODEL_DIR} --dataset c4 --wbits 2 --true_sequential --act_order --outlierorder 2.1 --save

# Run Outlier Reservation quantization to keep 0.07 bit of full-precison outliers and compute PPL results
python llama.py --method claq --model ${MODEL_DIR} --dataset c4 --wbits 2 --true_sequential --act_order --outlier_col_dynamic --save

# Run Adaptive Precision + Outlier Reservation quantization to quantize the model to 2.12 bit and compute PPL results
python llama.py --method claq --model ${MODEL_DIR} --dataset c4 --wbits 2 --true_sequential --act_order --outlierorder 2.05 --outlier_col_dynamic
```
...
python -m gptq.qeft.extract_outidx
--model ${MODEL_DIR}
--dataset c4
--wbits 4
--target_rank 128
